...
export default function ShortAnswerQuestion(props: { question: Question, uid: string, questionNumber: number, currentNumAnswers: number, gameId: string, lastEvent: GameEvent, setSubmitted: Function, revealAnswer: boolean }) {
