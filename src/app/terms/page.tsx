    ...
    return (
        <div>
            <div className={styles.terms_container}>
                ...
                <h3 className={styles.subtitle}>Effective Date: 6/26/2023</h3>
                ...
                <div className={styles.terms}>
                    ...
                    <p>
                        4. User Conduct
                        <p className={styles.section_content}>
                            When using Blitz, you agree to abide by the following guidelines:
                            You will not use the Service for any unlawful or unauthorized purposes.
                            You will not transmit any viruses, worms, or any other destructive code.
                            You will not interfere with or disrupt the Service or servers or networks connected to the Service.
                            You will not engage in any activity that may harm or exploit minors.
                            You will not collect or store personal information of other users without their consent.
                            You will not impersonate any person or entity or misrepresent your affiliation with any person or entity.
                            You will not use the Service in any manner that could disable, overburden, or impair the Service.
                            You will not attempt to gain unauthorized access to any part of the Service or its related systems or networks.
                        </p>
                    </p>
                    <p>
