                ...
                <div className={styles.privacy}>
                    <p>
                        ...
                        <p className={styles.section_content}>
                            ...
                            <p className={styles.section_content}>
                            1.2 Usage Data: We may collect non-personal information about how you interact with our website and services. This may include information such as your IP address, browser type, device information, referring/exit pages, and operating system. We may also collect information about your usage patterns and preferences.
                            </p>
                        </p>
                    </p>
                    <p>
