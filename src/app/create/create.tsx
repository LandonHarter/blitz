...
export default function CreateContent() {
    ...
    const [imagePath, setImagePath] = useState<string | null>('/images/missingimage.webp');
        ...
        generateQuiz(aiPrompt, aiNumQuestions, async (state: AIState, response: string, error: string | null) => {
            if (state === AIState.ERROR) {
                ...
                await setDoc(newSetRef, {
                    ...
                    public: false,
                    likes: 0,
                    image: '/images/missingimage.webp',
        ...
        <div>
            <div className={styles.create_form}>
                ...
                <button className={`${styles.provider_button} ${styles.quizlet_button}`} onClick={() => {
                    ...
                    <Image src='/images/providers/quizlet.webp' alt='quizlet' width={32} height={32} />
                    Import from Quizlet
                </button>
                <button className={`${styles.provider_button} ${styles.kahoot_button}`} onClick={() => {
                    ...
                    <Image src='/images/providers/kahoot.webp' alt='kahoot' width={35} height={35} />
                    Import from Kahoot
                </button>
